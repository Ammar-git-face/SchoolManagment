        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 md:ml-64 min-h-screen">
                ...
                <div className="md:hidden flex items-center justify-between bg-white px-4 py-3 shadow-sm sticky top-0 z-10">
                    ...
                    <h1 className="font-semibold text-gray-800">Mark Attendance</h1>
                    <div className="w-8" />
                </div>

                <div className="p-4 md:p-8 max-w-5xl mx-auto">
                    <h1 className="hidden md:block text-2xl font-bold text-gray-800 mb-6">Mark Attendance</h1>
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                <div className="flex gap-4 md:gap-6">
                                    {[
                                        ...
                                        { label: 'Total',   count: students.length, color: 'text-gray-700'},
                                    ].map(item => (
                            ...
                            <div className="hidden md:block bg-white rounded-xl shadow overflow-hidden mb-5">
                                <table className="w-full">
                                    <thead className="bg-gray-50 border-b">
                                        <tr>
                                            <th className="text-left px-5 py-3 text-sm text-gray-500 font-medium">#</th>
                                            <th className="text-left px-5 py-3 text-sm text-gray-500 font-medium">Student Name</th>
                                            <th className="text-left px-5 py-3 text-sm text-gray-500 font-medium">Status</th>
                                            <th className="text-left px-5 py-3 text-sm text-gray-500 font-medium">Remark</th>
                                        </tr>
                                    </thead>
                                            ...
                                            {['present', 'absent', 'late'].map(status => (
                                                <button key={status}
                                                    ...
                                                    className={`flex-1 py-1.5 rounded-lg text-xs font-medium capitalize transition-all
                                                        ${s.status === status ? STATUS_COLORS[status] : 'bg-gray-100 text-gray-500'}`}>
                                                    {status}
                                                </button>
                                            ))}
                                        </div>
