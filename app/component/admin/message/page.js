                                ...
                                {teachers.map((t) => (
                                    <div key={t._id}
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-medium text-black truncate">{t.fullname}</p>
                                        </div>
                                        <span className="bg-blue-100 text-blue-200 text-xs px-2 py-0.5 rounded-full flex-shrink-0">Teacher</span>
                                    </div>
                                ))}
                                {parents.map((p) => (
                                    <div key={p._id}
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-medium text-black truncate">{p.parent}</p>
                                        </div>
