        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 md:ml-64 min-h-screen">
                ...
                <div className="p-4 md:p-8 max-w-6xl mx-auto">
                    <h1 className="hidden md:block text-2xl font-bold text-gray-800 mb-6">Attendance Management</h1>
                        ...
                        <>
                            {summaryStats && (
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-5">
                                    {[
                                        { label: 'Total Records', value: summaryStats.total, color: 'text-gray-700' },
                            ...
                            <div className="bg-white rounded-xl shadow overflow-hidden">
                                <div className="px-5 py-4 border-b">
                                    <h2 className="font-semibold text-gray-700">Attendance by Class</h2>
                                </div>
                                        ...
                                        {[...classSummary].sort((a, b) => b.attendanceRate - a.attendanceRate).map(cls => (
                                            <div key={cls.className} className="px-4 md:px-5 py-4">
                                                <div className="flex justify-between items-start md:items-center mb-2 gap-2">
                                                    <div>
                                                        <span className="font-medium text-gray-800 text-sm md:text-base">{cls.className}</span>
                                                ...
                                                <tbody className="divide-y divide-gray-100">
                                                    {records.map(r => (
                                                        <tr key={r._id} className="hover:bg-gray-50">
                                                            ...
                                                            <td className="px-5 py-3 text-sm text-gray-600">{r.teacherName}</td>
