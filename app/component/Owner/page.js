        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <div className="font-bold text-gray-800 text-lg">{schoolName}</div>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="text-right hidden md:block">
                            <div className="text-sm font-medium text-gray-700">{ownerName}</div>
                ...
                <>
                    ...
                    <div className="fixed left-0 top-0 h-full w-64 bg-white z-30 shadow-xl p-6">
                        <div className="flex items-center justify-between mb-8">
                            <div className="font-bold text-xl text-blue-600">{schoolName}</div>
                        ...
                        {['Dashboard', 'Payroll', 'Logout'].map(item => (
                            ...
                            }} className="w-full text-left py-3 px-4 rounded-lg hover:bg-gray-100 text-gray-700 mb-1 text-sm">
                                {item}
                            </button>
                        ))}
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
                    {[
                        { label: 'Total Students', value: stats?.totalStudents || 0, icon: <GraduationCap className="w-5 h-5" />, color: 'bg-blue-50 text-blue-600' },
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
                    {[
                        ...
                        { label: 'Payroll Paid', value: formatNaira(stats?.totalPayrollPaid), color: 'text-blue-600' },
                ...
                <div className="bg-white rounded-xl shadow p-5 mb-6">
                    <div className="flex justify-between items-center mb-3">
                        <h2 className="font-semibold text-gray-700">Fee Collection Rate</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                    <div className="bg-white rounded-xl shadow p-5">
                        <h2 className="font-semibold text-gray-700 mb-4">Monthly Fee Revenue</h2>
                    ...
                    <div className="bg-white rounded-xl shadow p-5">
                        <h2 className="font-semibold text-gray-700 mb-4">Fee Status Breakdown</h2>
                ...
                <div className="bg-white rounded-xl shadow overflow-hidden">
                    <div className="px-5 py-4 border-b flex justify-between items-center">
                        <h2 className="font-semibold text-gray-700">Recent Fee Payments</h2>
                        ...
                        <div className="divide-y divide-gray-100">
                            {stats.recentPayments.map(p => (
                                <div key={p._id} className="px-5 py-3 flex items-center justify-between">
                                    <div>
                                        <div className="font-medium text-gray-800 text-sm">{p.parentName}</div>
